...
<div id="sf_admin_container">
  <h1><?php echo __('Editing Job "%%company%% is looking for a %%position%%"', array('%%company%%' => $jobeet_job->getstrtoupper('c')ompany(), '%%position%%' => $jobeet_job->getstrtoupper('p')osition()), 'messages') ?></h1>
